...
data class Hero(
    ...
    val primaryAttribute: HeroAttribute,      //add hero attribute sealed class
    val attackType: HeroAttackType,  //add hero attack type here
    val roles: List<HeroRole>,  //add Hero roles here
    val img: String,
    val icon: String,
